...
-- inserciones
INSERT INTO `usuarios` (`id`, `nombre`, `apellidos`, `email`, `password`, `rol`, `confirmado`, `token`, `token_exp`) VALUES (NULL, '', '', 'admin@gmail.com', '$2y$10$vVIyox7hapBPd68pbH6VUevDQKFsWhP48JVrndlm5d/LfZX3rijym', 'admin', 'si', '', '0000-00-00 00:00:00');

INSERT INTO `usuarios` (`id`, `nombre`, `apellidos`, `email`, `password`, `rol`, `confirmado`, `token`, `token_exp`) VALUES (NULL, '', '', 'confirmado@gmail.com', '$2y$10$FkBDwDtsI9R32r4JtD83Sez2K5ETgr8j9fIXtkHu3MILaRJ43E27C', 'user', 'si', '', '0000-00-00 00:00:00');
